    ...
    t = window.Morris = {}, e = jQuery, t.EventEmitter = function() {
        ...
        return o(r, n), r.prototype.gridDefaults = {
           ...
           // yaxisLabel:"the graph"
            ...
            {
                this.drawYAxisTitle(this.options.yaxisLabel)
            }
        ...
        r.prototype.drawYAxisTitle = function (n) {
            
            return this.raphael.text(5, 200, n).attr("font-size", 13).attr("font-family", "sans-serif").attr("font-weight", "bold").attr("fill", "#0b62a4").attr("text-anchor", "middle").transform("r270")
            },
        ...
        return o(n, e), n.prototype.init = function() {
            ...
            if (this.options.xaxisLabel) {
                this.drawXAxisTitle(this.options.xaxisLabel)
            }
         ...
         n.prototype.drawXAxisTitle = function (n) {
                var r;
                return r = this.raphael.text(250, 338, n).attr("font-size", 12).attr("font-family", "sans-serif").attr("font-weight", "bold").attr("fill", "#0b62a4")
            },
        ...
        return o(r, n), r.prototype.init = function() {
            ...
            var r;
            return r = this.raphael.text(e, t, n).attr("font-size", this.options.gridTextSize).attr("font-family", this.options.gridTextFamily).attr("font-weight", "bold").attr("fill", this.options.gridTextColor)
        },
        r.prototype.drawXAxisTitle = function (n) {
            var r;
            return r = this.raphael.text(250, 335, n).attr("font-size", 13).attr("font-family", "sans-serif").attr("font-weight", "bold").attr("fill", "#0b62a4")
        },
